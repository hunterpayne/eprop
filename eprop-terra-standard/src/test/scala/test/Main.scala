...
import org.eprop.StandardFixture
...
object Main extends App with StandardFixture {
  ...
  println("Standard Terra Eprop tests worked")

  //println("Standard Terra Eprop tests disabled")
}
